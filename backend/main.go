...
func main() {
	...
	mux.HandleFunc("/getusers", urlHandlers.HandleGetUsers)
	mux.HandleFunc("/getmessages", urlHandlers.HandleGetMessages)
	mux.HandleFunc("/loadmoremessages", urlHandlers.HandleLoadMoreMessages)
